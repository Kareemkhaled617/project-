...
class _LandingScreenState extends State<LandingScreen> {
  ...
  camera() async {
    ...
    Navigator.of(context)
        .push(MaterialPageRoute(builder: (_) => DisplayPhoto(image: pickedFile)));
  }
  gallary() async {
    final XFile? pickedFile = await ImagePicker().pickImage(
          ...
          child: ListBody(
            children: <Widget>[
              GestureDetector(
                child:Column(
                  children: const[
                    Text('Choose One',style: TextStyle(color: Colors.blueGrey,fontWeight: FontWeight.w900,fontSize: 13),),
                    SizedBox(height: 20,),
